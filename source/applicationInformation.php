        ...
        <form action="" method="" class="form" name="ApplicantInfo" enctype="multipart/form-data">
        	<fieldset>
                ...
                <legend>Ethnicity/Race(Check One):</legend>
                    ...
                    <div class="form-checkbox"><input type="checkbox" name="ethnicity" value="Asian/Pacifc Islander" />Asian/Pacific Islander</div>
            ...
            <p>** Applicant agrees to allow their picture and first name to be placed on materials which can be given to individuals or corporate sponsors. All other personal information will be kept condential. Please attach 2 wallet sized(2x3) color photographs to be placed on ornaments. Each donor will buy approximately $75 in gifts. Please indicate below which items are needed by following the guidelines for each box. Please call (801) 654-8449 if you have questions. **</p>
            </form>
